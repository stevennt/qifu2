...
public class Out implements UIComponent {
	...
	public String getHtml() throws Exception {
		...
		UIComponentValueUtils.setValue( this.pageContext, paramMap, "objVal", this.value, ( YesNo.YES.equals(escapeHtml) ? true : false ), ( YesNo.YES.equals(escapeJavaScript) ? true : false ), this.scope );
