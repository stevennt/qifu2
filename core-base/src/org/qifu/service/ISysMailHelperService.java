...
public interface ISysMailHelperService<T extends java.io.Serializable, E extends java.io.Serializable, PK extends java.io.Serializable> extends IBaseService<T, E, PK> {
	
	public static String MAPPER_ID_PO2VO="sysMailHelper.po2vo";
	public static String MAPPER_ID_VO2PO="sysMailHelper.vo2po";
