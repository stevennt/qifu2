...
import org.qifu.dao.ISysTemplateParamDAO;
...
public class SysTemplateParamServiceImpl extends BaseService<SysTemplateParamVO, TbSysTemplateParam, String> implements ISysTemplateParamService<SysTemplateParamVO, TbSysTemplateParam, String> {
	...
	@Required		
	public void setSysTemplateParamDAO(ISysTemplateParamDAO<TbSysTemplateParam, String> sysTemplateParamDAO) {
	...
	private Map<String, Object> getQueryGridParameter(SearchValue searchValue) throws Exception {
		return super.getQueryParamHandler(searchValue).fullEquals4TextField("templateOid").getValue();
	}	
