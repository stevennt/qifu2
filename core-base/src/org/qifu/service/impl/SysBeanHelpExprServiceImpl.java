...
public class SysBeanHelpExprServiceImpl extends BaseService<SysBeanHelpExprVO, TbSysBeanHelpExpr, String> implements ISysBeanHelpExprService<SysBeanHelpExprVO, TbSysBeanHelpExpr, String> {
	...
	@Required		
	public void setSysBeanHelpExprDAO(ISysBeanHelpExprDAO<TbSysBeanHelpExpr, String> sysBeanHelpExprDAO) {
	...
	private Map<String, Object> getQueryGridParameter(SearchValue searchValue) throws Exception {
		return super.getQueryParamHandler(searchValue).fullEquals4TextField("helpOid").getValue();
	}
