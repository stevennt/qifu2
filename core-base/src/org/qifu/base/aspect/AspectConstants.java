...
public class AspectConstants {
	 ...
	 */
	public static final String DATA_ACCESS_OBJECT_PACKAGE = " @annotation(org.qifu.base.aspect.EnableAspectForDataAccessObjectMethod) || execution(* org.qifu.base.dao.*.*(..) ) || execution(* org.qifu.dao..*.*(..) ) || execution(* org.qifu.common.dao..*.*(..) ) || execution(* org.qifu.bsc.dao..*.*(..) ) ";
	 ...
	 */
	public static final String LOGIC_SERVICE_PACKAGE = " @annotation(org.qifu.base.aspect.EnableAspectForLogicServiceMethod) || execution(* org.qifu.base.service.logic.*.*(..) ) || execution(* org.qifu.service.logic..*.*(..) ) || execution(* org.qifu.common.service.logic..*.*(..) ) || execution(* org.qifu.bsc.service.logic..*.*(..) ) ";
