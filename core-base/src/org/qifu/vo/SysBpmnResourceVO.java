...
public class SysBpmnResourceVO extends BaseValueObj implements java.io.Serializable {
	...
	public SysBpmnResourceVO(String oid, String id, String deploymentId, String name, String description) {
		super();
		this.oid = oid;
		this.id = id;
	...
	public SysBpmnResourceVO(String oid, String id, String deploymentId, String name, byte[] content, String description) {
		super();
		this.oid = oid;
		this.id = id;
		this.deploymentId = deploymentId;
