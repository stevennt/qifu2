...
public class SysJreportVO extends BaseValueObj implements java.io.Serializable {
	...
	public SysJreportVO(String oid, String reportId, String file, String isCompile, byte[] content, String description) {
		this.oid = oid;
	...
	public SysJreportVO(String oid, String reportId, String file, String isCompile, String description) {
		this.oid = oid;
		this.reportId = reportId;
		this.file = file;
		this.isCompile = isCompile;
